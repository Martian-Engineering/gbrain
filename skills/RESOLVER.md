...
| "correct this", "this is wrong", "fix this brain page", "these are the same thing", "this is a different person" | `skills/knowledge-correction/SKILL.md` |
| "apply nightly semantic repair manifest" | `skills/nightly-semantic-repair/SKILL.md` |
