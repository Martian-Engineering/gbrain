...
// Source: admin/dist/ at 2026-07-26.
//
...
import A_0_assets_index_GxkWX7v3_css from '../admin/dist/assets/index-GxkWX7v3.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_QAPo_KNh_js from '../admin/dist/assets/index-QAPo_KNh.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-GxkWX7v3.css": { path: A_0_assets_index_GxkWX7v3_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-QAPo_KNh.js": { path: A_1_assets_index_QAPo_KNh_js as unknown as string, mime: "application/javascript; charset=utf-8" },
