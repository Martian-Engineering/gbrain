...
function mkPair(slugA: string, slugB: string): ContradictionPair {
  return {
    ...
    a: { slug: slugA, source_id: null, chunk_id: 1, take_id: null, source_tier: 'curated', holder: null, text: 'a', effective_date: null, effective_date_source: null },
    b: { slug: slugB, source_id: null, chunk_id: 2, take_id: null, source_tier: 'curated', holder: null, text: 'b', effective_date: null, effective_date_source: null },
    combined_score: 1,
  };
}
