    ...
    per_query: findings.length > 0 ? [
      {
        ...
        contradictions: findings.map((f, i) => ({
          ...
          a: { slug: f.slugA, source_id: null, chunk_id: i + 1, take_id: null, source_tier: 'curated' as const, holder: null, text: 'a', effective_date: null, effective_date_source: null },
          b: { slug: f.slugB, source_id: null, chunk_id: i + 100, take_id: null, source_tier: 'bulk' as const, holder: null, text: 'b', effective_date: null, effective_date_source: null },
          combined_score: 1.0,
